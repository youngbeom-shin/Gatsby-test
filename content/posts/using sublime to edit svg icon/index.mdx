---
title: using sublime to edit svg icon
author: youngbeom
date: 2018-07-25
timeToRead: 5
hero: ./images/hero.png
excerpt: 使用sublime管理并编辑svg图片.
---
...
首先我们频繁会改动的svg主要集中在默认的icon，不包含世界杯地图等这样的特殊样式地图，以交通类目下的bicycle为例，icon主要是分为两个部分，交通主题色圆形的背景部分  

circle cx="9.5" cy="9.5" r="9.5" fill="#6c7"/

和背景上面的自行车图形部分   

d="M10.5,5.5a.5.5,0,0,0,0,1H11v.7L8.3,8.8,7.7,7.5h.7a.5.5,0,0,0,0-1h-2a.5.5,0,0,0,0,1h.2L7,8.6c-.2,0-.4-.1-.6-.1A2.475,2.475,0,0,0,4,11.046L4,11.1a2.6,2.6,0,0,0,2.5,2.4A2.476,2.476,0,0,0,9,11.049V11H9a2.011,2.011,0,0,0-.4-1.3l2.5-1.4.4.4A2.526,2.526,0,0,0,10,11a2.5,2.5,0,1,0,2.7-2.5L12,7.8V6a.457.457,0,0,0-.4-.5Zm-4,4A1.5,1.5,0,1,1,5,11,1.5,1.5,0,0,1,6.5,9.5Zm6,0h0A1.454,1.454,0,0,1,14,10.9V11a1.5,1.5,0,0,1-3,0,1.473,1.473,0,0,1,1.445-1.5Z" fill="#fff"
...
在find输入框中填写需要替换的16进制颜色代码，在replace输入框中填写新的代码，之后点击右下角的Replace之后点击file—save all，操作完成后就能在文件夹内看到变化后的图标。  
